...
namespace P2\Bundle\RoleBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;

use P2\Bundle\RoleBundle\Entity\Role;
use P2\Bundle\RoleBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    private $P2_ERR_CREATING_UPDATING = 'The were some errors and the role couldn\'t be %s';
    private $P2_SUCCESS_CRE_UPD_DEL = 'Role %s successfully';
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('P2RoleBundle:Role')->findAll();

        return $this->render('P2RoleBundle:Role:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('P2RoleBundle:Role:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('P2RoleBundle:Role')->find($id);

        if (!$entity) {
            return $this->render('P2RoleBundle:Default:404.html.twig',
             array('message' => 'Sorry, we couldn\'t find that role'));//not found
        }

        $deleteForm = $this->createDeleteForm($id);

        return $this->render('P2RoleBundle:Role:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('P2RoleBundle:Role:edit.html.twig', array(
            'entity'      => $entity,
    ...
    /**
     * Displays a form to delete an existing Role entity.
     *
     */
    public function showDeleteAction($id)
    {
        ...
        return $this->render('P2RoleBundle:Role:delete.html.twig', array(
            'entity'      => $entity,
            'delete_form' => $deleteForm->createView(),
        ));
    }
