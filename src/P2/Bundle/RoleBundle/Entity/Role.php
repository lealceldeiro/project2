...
namespace P2\Bundle\RoleBundle\Entity;
 ...
 *
 * @ORM\Table(name="role")
 * @ORM\Entity(repositoryClass="P2\Bundle\RoleBundle\Entity\Repository\RoleRepository")
 */
class Role
{
    /**
     ...
     * Get attribute
     *
     * String representation of the Role entity.
     *
     * @return string
     */
